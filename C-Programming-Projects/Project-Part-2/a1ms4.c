...
int main(void)
{
    ...
    getName(&iContact.name);

    // Call the Contact function getAddress to store the values for the Address member
    getAddress(&iContact.address);

    // Call the Contact function getNumbers to store the values for the Numbers member
    getNumbers(&iContact.numbers);
    ...
    printf("Name Details\n");
    printf("------------\n");
    printf("First name: %s\n", iContact.name.firstName);
    printf("Middle initial(s): %s\n", iContact.name.middleInitial);
    printf("Last name: %s\n", iContact.name.lastName);
    printf("\n");
    printf("Address Details\n");
    printf("---------------\n");
    printf("Street number: %d\n", iContact.address.streetNumber);
    printf("Street name: %s\n", iContact.address.street);
    printf("Apartment: %d\n", iContact.address.apartmentNumber);
    printf("Postal code: %s\n", iContact.address.postalCode);
    printf("City: %s\n", iContact.address.city);
    printf("\n");
    printf("Phone Numbers\n");
    printf("-------------\n");
    printf("Cell phone number: %s\n", iContact.numbers.cell);
    printf("Home phone number: %s\n", iContact.numbers.home);
    printf("Business phone number: %s\n", iContact.numbers.business);
